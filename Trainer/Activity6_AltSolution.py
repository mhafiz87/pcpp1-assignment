...
class Machine:
    ...
    def runs(self):
        ...
        if user in self.authorized_users:
            ...
            raise PermissionErrorCustom("Only machine operators can access runs.")
    ...
    def production_details(self):
        ...
        if user in self.authorized_users:
            ...
            raise PermissionErrorCustom("Only machine operators can access production details.")
        ...
        for row in reader:
            try:
                ...
                if run_start <= datetime.strptime(target_date, "%Y-%m-%d") <= run_end:
                    ...
                    machine.current_user = current_user
